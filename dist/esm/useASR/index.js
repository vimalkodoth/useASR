...
function useASR(config) {
    var _this = this;
    var _a = useState(false), isRecording = _a[0], setIsRecording = _a[1];
    var _b = useState(null), recordedBlob = _b[0], setRecordedBlob = _b[1];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    onStopRecording = function () { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    audioBuffer = _a.sent();
                                    wavBlob = new Blob([audioBufferToWav(audioBuffer)], {
                                        type: 'audio/wav',
                                    });
